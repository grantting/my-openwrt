...
sudo sed -i 's|src/gz immortalwrt_packages https://downloads\.immortalwrt\.org/releases/23.05.3/packages/aarch64_cortex-a53|src/gz immortalwrt_packages https://op.dllkids.xyz/packages|g' repositories.conf
